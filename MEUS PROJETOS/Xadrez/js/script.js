function tabu_xadrez(){
    window.location.href = "./pages/tabuleiro.html";
}

// function create_tabuleiro(){
//     // Tabuleiro de xadrez e composta por 64 casas, 32 brancas e 32 pretas.
//     var tabuleiro = [];
    
//     for (var i = 0; i < 8; i++) {
//         tabuleiro[i] = []; // Cria uma nova linha
//         for (var j = 0; j < 8; j++) {
//             // Alterna entre "branco" e "preto" para as casas
//             if ((i + j) % 2 === 0) {
//                 tabuleiro[i][j] = "branco"; // Pode ser alterado para "preto" se preferir
//             } else {
//                 tabuleiro[i][j] = "preto"; // Pode ser alterado para "branco" se preferir
//             }
//         }
//     }
